...
doTimeDependent = True #Make True to do time-dependent calculation

if(doTimeDependent):
#Use this for Time-Dependent calculations:
    wfr.allocate(3, 10, 10) #Numbers of points vs Photon Energy, Horizontal and Vertical Positions
    wfr.presFT = 1 #presentation/domain: 0- frequency (photon energy), 1- time
    wfr.mesh.eStart = -0.5*GsnBm.sigT #Initial Time [s] 
    wfr.mesh.eFin = 0.5*GsnBm.sigT #Final Time [s]
else:
